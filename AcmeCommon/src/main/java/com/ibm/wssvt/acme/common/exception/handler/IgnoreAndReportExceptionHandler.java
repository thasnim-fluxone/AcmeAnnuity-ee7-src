...
public class IgnoreAndReportExceptionHandler implements IExceptionHandler {
	...
	public IExceptionHandlerResult handleException(
		...
		result.setAction(ExceptionAction.REPORT);
		result.setMessage("Exception:  " + exception.getClass().getName() + ", matching pattern: " 
				+ exceptionHandlerConfiguration.getExceptionClassName() + " was ignored, but reported" );
		return result;
	}
