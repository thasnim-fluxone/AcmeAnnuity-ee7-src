...
public class PolicyPersistenceFactory {
	...
	public static PolicyPersistence<IPersisteble<?>, String, String> getPolicyPersistence(Configrable<String, String> configrable, AcmeLogger logger) 
	throws ServerPersistenceModuleException{   		
		...
		if (AnnuityPersistenceType.JPA_SA.equals(type)){
			...
			try {
				...
				Object ref = ic.lookup(configrable.getConfiguration().getParameterValue("jpaPolicyEjbLocalJndi"));					
