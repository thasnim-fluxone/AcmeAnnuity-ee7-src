package com.ibm.wssvt.acme.annuity.common.business.osgi;
...
public interface AnnuityMgmtSvcOsgi {
	
	public IAnnuity findAnnuityById(IAnnuity annuity) throws EntityNotFoundException, InvalidArgumentException, ServerInternalErrorException;		
	public IAnnuity createAnnuity(IAnnuity ann) throws EntityAlreadyExistsException, InvalidArgumentException, ServerInternalErrorException;			
	public IAnnuity updateAnnuity(IAnnuity ann) throws InvalidArgumentException, ServerInternalErrorException;			
	public void deleteAnnuity(IAnnuity annuity) throws ServerInternalErrorException, InvalidArgumentException;	
	public IAnnuityHolder findAnnuityHolder(IAnnuity annuity) throws EntityNotFoundException, InvalidArgumentException, ServerInternalErrorException;
