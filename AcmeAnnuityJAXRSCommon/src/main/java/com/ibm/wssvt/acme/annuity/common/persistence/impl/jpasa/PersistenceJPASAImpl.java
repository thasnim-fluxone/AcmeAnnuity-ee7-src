 ...
 */
public class PersistenceJPASAImpl extends BasicPersistenceJPASAImpl<String> implements AnnuityPersistence<IPersisteble<String>, String, String>{
	...
	/*
	public IPersisteble createObject(IPersisteble persistebleObject) throws ServerPersistenceModuleException, EntityAlreadyExistsException, InvalidArgumentException {
	...
	public IPersisteble updateObject(IPersisteble persisteble) throws ServerPersistenceModuleException, InvalidArgumentException {
		EntityManager em = null;
		try{
...
/*
	private synchronized EntityManagerFactory getEntityManagerFactory(Configrable<String, String> configrable) throws InvalidArgumentException{
