...
public class AnnuityBusinessServiceLookup {
	...
	public IAnnuityService getAnnuityAnnuityService(Configrable<String, String> inConfig) throws InvalidConfigurationException, NamingException, RemoteException, AnnuitySecurityException{
		...
		}else if (AnnuityServiceName.EJB2x.equals(annuityServiceName)){
			logger.info("Hopping to: " + annuityServiceName);			
			getEJB2xServiceConfig(inConfig, configrable);		
			return EJB2xServiceLookup.getAnnuityEJB2xService(configrable, logger);
		...
		}else if (AnnuityServiceName.EJB30JAXRPC_EJB.equals(annuityServiceName)){
			logger.info("Hopping to: " + annuityServiceName);
			getEJB30JAXRPC_EJBServiceConfig(inConfig, configrable);
			return EJB3JAXRPCEJBServiceLookup.getAnnuityEJB3JAXRPCEJBService(configrable, logger);
		}else if (AnnuityServiceName.EJB2xJAXRPC_EJB.equals(annuityServiceName)){
			logger.info("Hopping to: " + annuityServiceName);
			getEJB2xJAXRPC_EJBServiceConfig(inConfig, configrable);
			return EJB2xJAXRPCEJBServiceLookup.getAnnuityEJB2xJAXRPCEJBService(configrable, logger);			
		...
		}else if (AnnuityServiceName.EJB30JAXRPC_JAXRPC.equals(annuityServiceName)){
			logger.info("Hopping to: " + annuityServiceName);
			getEJB30JAXRPC_JAXRPCServiceConfig(inConfig, configrable);
			return EJB30JAXRPCJAXRPCServiceLookup.getAnnuityEJB30JAXRPCJAXRPCService(null, configrable, logger);
		}else if (AnnuityServiceName.EJB2xJAXRPC_JAXRPC.equals(annuityServiceName)){
			getEJB2xJAXRPC_JAXRPCServiceConfig(inConfig, configrable);					
			return EJB2xJAXRPCJAXRPCServiceLookup.getAnnuityEJB2xJAXRPCJAXRPCService(null, configrable, logger);
		...
		}/*else if (AnnuityServiceName.POJO_JAXRPC.equals(annuityServiceName)){
			logger.info("Hopping to: " + annuityServiceName);
			getPOJO_JAXRPCServiceConfig(inConfig, configrable);
			return PojoJAXRPCServiceLookup.getAnnuityPojoJAXRPCService(null, configrable, logger);
