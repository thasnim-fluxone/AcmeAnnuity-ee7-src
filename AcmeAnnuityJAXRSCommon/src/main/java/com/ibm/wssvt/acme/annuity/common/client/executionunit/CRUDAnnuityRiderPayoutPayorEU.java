...
public class CRUDAnnuityRiderPayoutPayorEU extends AbastractAnnuityExecutionUnit {
	...
	public void execute() {
		...
		logger.info("Creating Annuity with Rider");
		...
		logger.info("Verifying Annuity with Rider");
		try {
		...
		logger.info("Updating Annuity with Rider");
		try {
		...
		logger.info("Deleting Annuity with Rider");
		try {
		...
		logger.info("Creating Annuity with Payout");
		// IAnnuity annuity = null;
		// AnnuityType annuityType = getRandomEnum(AnnuityType.class);
		try {
		...
		logger.info("Verifying Annuity with Payout");
		try {
			verifyAnnuityValues(annuity, annuityType);
		} catch (Exception e) {
			logger
		...
		logger.info("Updating Annuity with Payout");
		try {
		...
		logger.info("Deleting Annuity with Payout");
		try {
		...
		logger.info("Creating Annuity with Payor");
		try {
		...
		logger.info("Verifying Annuity with Payor");
		try {
			verifyAnnuityValues(annuity, annuityType);
		} catch (Exception e) {
		...
		logger.info("Updating Annuity with Payor");
		try {
		...
		logger.info("Deleting Annuity with Payor");
		try {
