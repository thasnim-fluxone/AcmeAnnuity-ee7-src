...
public class AnnuityEJB31AsynchRemoteServiceProxy implements IAnnuityService {
    ...
    public AnnuityEJB31AsynchRemoteServiceProxy(
            AnnuityMgmtAsynchSvcEJB31 remote, AcmeLogger logger) {
        this.remote = remote;
        this.logger = logger;
    }
    ...
    InvalidArgumentException {
        Future<IAnnuity> future = remote.findAnnuityById(annuity);
    ...
    throws EntityNotFoundException, ServerInternalErrorException,
    InvalidArgumentException {
        Future<IAnnuityHolder> future = remote.findAnnuityHolder(annuity);
        getAsyncTimout(annuity);
        try {
            return future.get(remoteAsynchTimeout, TimeUnit.SECONDS);
        } catch (ExecutionException e) {
    ...
    throws EntityNotFoundException, ServerInternalErrorException,
    InvalidArgumentException {
        Future<IContact> future = remote.findContactById(contact);
    ...
    throws ServerInternalErrorException, InvalidArgumentException {
        Future<List<IAnnuity>> future = remote
    ...
    throws EntityNotFoundException, ServerInternalErrorException,
    InvalidArgumentException {
        Future<IAnnuityHolder> future = remote.findHolderById(annuityHolder);
        getAsyncTimout(annuityHolder);
        try {
            return future.get(remoteAsynchTimeout, TimeUnit.SECONDS);
        } catch (InterruptedException e) {
    ...
    ServerInternalErrorException, InvalidArgumentException {
        Future<IPayor> future = remote.findPayorById(payor);
        try {
    ...
    throws EntityNotFoundException, ServerInternalErrorException,
    InvalidArgumentException {
        Future<IPayout> future = remote.findPayoutById(payout);
        try {
    ...
    ServerInternalErrorException, InvalidArgumentException {
        Future<IRider> future = remote.findRiderById(rider);
        try {
    ...
    InvalidArgumentException {
        Future<IAnnuity> future = remote.createAnnuity(ann);
        try {
    ...
    throws ServerInternalErrorException, EntityAlreadyExistsException,
    InvalidArgumentException {
        Future<IAnnuityHolder> future = remote.createAnnuityHolder(annHolder);
        try {
    ...
    throws ServerInternalErrorException, EntityAlreadyExistsException,
    InvalidArgumentException {
        Future<IContact> future = remote.createContact(contact);
        try {
    ...
    throws ServerInternalErrorException, EntityAlreadyExistsException,
    InvalidArgumentException {
        Future<IPayor> future = remote.createPayor(payor);
        try {
            waitAndCheckForValidResponse(future, payor);
            return future.get();
        } catch (ExecutionException e) {
    ...
    throws ServerInternalErrorException, InvalidArgumentException {
        ...
        Future<IAnnuity> future = remote.updateAnnuity(ann);
        try {
            waitAndCheckForValidResponse(future, ann);
    ...
    throws ServerInternalErrorException, InvalidArgumentException {
        Future<IAnnuityHolder> future = remote.updateAnnuityHolder(annHolder);
        try {
            waitAndCheckForValidResponse(future, annHolder);
    ...
    throws ServerInternalErrorException, InvalidArgumentException {
        Future<IContact> future = remote.updateContact(contact);
        try {
            waitAndCheckForValidResponse(future, contact);
    ...
    throws ServerInternalErrorException, InvalidArgumentException {
        Future<IPayor> future = remote.updatePayor(payor);
        try {
            waitAndCheckForValidResponse(future, payor);
    ...
    throws ServerInternalErrorException, InvalidArgumentException {
        Future<List<IAnnuity>> future = remote.findPayorAnnuities(payor);
        try {
            waitAndCheckForValidResponse(future, payor);
    ...
    throws ServerInternalErrorException, EntityAlreadyExistsException,
    InvalidArgumentException {
        Future<IPayout> future = remote.createPayout(payout);
        try {
            waitAndCheckForValidResponse(future, payout);
    ...
    throws ServerInternalErrorException, InvalidArgumentException {
        Future<IPayout> future = remote.updatePayout(payout);
        try {
            waitAndCheckForValidResponse(future, payout);
    ...
    private void getAsyncTimout(Configrable<String, String> configrable) {
        ...
        if (asynchTimeoutStringValue != null
            ...
            logger.fine("Setting remoteAsynchTimeout = " + remoteAsynchTimeout);
        }
    }
