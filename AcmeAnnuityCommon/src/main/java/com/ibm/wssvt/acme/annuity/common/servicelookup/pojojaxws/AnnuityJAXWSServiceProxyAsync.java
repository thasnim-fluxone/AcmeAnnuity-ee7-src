...
public class AnnuityJAXWSServiceProxyAsync implements IAnnuityService{
	...
	private void processInterruptedException(InterruptedException e){
		logger.log(Level.WARNING,"Got an unexpected InterruptedException while waiting for a response object");
	...
	private void processCommonException (Throwable e) throws ServerInternalErrorException, InvalidArgumentException {		
		if (e instanceof InvalidArgumentException_Exception) {
			...
			logger.log(Level.INFO, "unable to detect the type of the exception.  Returning a RuntimeException.  Error is: " + ExceptionFormatter.deepFormatToString(e), e);
			e.printStackTrace();
