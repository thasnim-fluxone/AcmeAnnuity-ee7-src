...
/*
 * This code was imported from existing tWAS application as part of the 
 * developer experience JAXWS CDI 1.2 for 3Q15 (task #165703) 
 *  
 */
...
import com.ibm.wssvt.acme.annuity.common.business.jaxws.JAXWSBusinessBaseProxyJCDI;
...
//com.ibm.wssvt.acme.annuity.common.business.ejbws.ejb3jaxws.AnnuityMgmtSvcEJB30JAXWSSEI
...
@Dependent
public class AnnuityMgmtSvcEJB30JAXWJCDISBean extends JAXWSBusinessBaseProxyJCDI implements AnnuityMgmtSvcJAXWS{
	...
	String CLASSNAME = AnnuityMgmtSvcEJB30JAXWJCDISBean.class.getName();
